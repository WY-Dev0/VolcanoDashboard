...
> IoK8sApiCoordinationV1Lease createCoordinationV1NamespacedLease(namespace, body, opts)
...
let apiInstance = new Kubernetes.CoordinationV1Api();
let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects
let body = new Kubernetes.IoK8sApiCoordinationV1Lease(); // IoK8sApiCoordinationV1Lease | 
let opts = {
...
apiInstance.createCoordinationV1NamespacedLease(namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> IoK8sApimachineryPkgApisMetaV1Status deleteCoordinationV1CollectionNamespacedLease(namespace, opts)
...
apiInstance.deleteCoordinationV1CollectionNamespacedLease(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteCoordinationV1NamespacedLease(name, namespace, opts)
...
apiInstance.deleteCoordinationV1NamespacedLease(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Kubernetes.CoordinationV1Api();
apiInstance.getCoordinationV1APIResources((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiCoordinationV1LeaseList listCoordinationV1LeaseForAllNamespaces(opts)
...
apiInstance.listCoordinationV1LeaseForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiCoordinationV1LeaseList listCoordinationV1NamespacedLease(namespace, opts)
...
apiInstance.listCoordinationV1NamespacedLease(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiCoordinationV1Lease patchCoordinationV1NamespacedLease(name, namespace, body, opts)
...
apiInstance.patchCoordinationV1NamespacedLease(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiCoordinationV1Lease readCoordinationV1NamespacedLease(name, namespace, opts)
...
apiInstance.readCoordinationV1NamespacedLease(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiCoordinationV1Lease replaceCoordinationV1NamespacedLease(name, namespace, body, opts)
...
apiInstance.replaceCoordinationV1NamespacedLease(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchCoordinationV1LeaseListForAllNamespaces(opts)
...
apiInstance.watchCoordinationV1LeaseListForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchCoordinationV1NamespacedLease(name, namespace, opts)
...
apiInstance.watchCoordinationV1NamespacedLease(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchCoordinationV1NamespacedLeaseList(namespace, opts)
...
apiInstance.watchCoordinationV1NamespacedLeaseList(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
