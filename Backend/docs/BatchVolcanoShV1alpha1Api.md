# Kubernetes.BatchVolcanoShV1alpha1Api

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#createBatchVolcanoShV1alpha1NamespacedJob) | **POST** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs | 
[**deleteBatchVolcanoShV1alpha1CollectionNamespacedJob**](BatchVolcanoShV1alpha1Api.md#deleteBatchVolcanoShV1alpha1CollectionNamespacedJob) | **DELETE** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs | 
[**deleteBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#deleteBatchVolcanoShV1alpha1NamespacedJob) | **DELETE** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name} | 
[**listBatchVolcanoShV1alpha1JobForAllNamespaces**](BatchVolcanoShV1alpha1Api.md#listBatchVolcanoShV1alpha1JobForAllNamespaces) | **GET** /apis/batch.volcano.sh/v1alpha1/jobs | 
[**listBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#listBatchVolcanoShV1alpha1NamespacedJob) | **GET** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs | 
[**patchBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#patchBatchVolcanoShV1alpha1NamespacedJob) | **PATCH** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name} | 
[**patchBatchVolcanoShV1alpha1NamespacedJobStatus**](BatchVolcanoShV1alpha1Api.md#patchBatchVolcanoShV1alpha1NamespacedJobStatus) | **PATCH** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name}/status | 
[**readBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#readBatchVolcanoShV1alpha1NamespacedJob) | **GET** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name} | 
[**readBatchVolcanoShV1alpha1NamespacedJobStatus**](BatchVolcanoShV1alpha1Api.md#readBatchVolcanoShV1alpha1NamespacedJobStatus) | **GET** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name}/status | 
[**replaceBatchVolcanoShV1alpha1NamespacedJob**](BatchVolcanoShV1alpha1Api.md#replaceBatchVolcanoShV1alpha1NamespacedJob) | **PUT** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name} | 
[**replaceBatchVolcanoShV1alpha1NamespacedJobStatus**](BatchVolcanoShV1alpha1Api.md#replaceBatchVolcanoShV1alpha1NamespacedJobStatus) | **PUT** /apis/batch.volcano.sh/v1alpha1/namespaces/{namespace}/jobs/{name}/status | 



## createBatchVolcanoShV1alpha1NamespacedJob

> ShVolcanoBatchV1alpha1Job createBatchVolcanoShV1alpha1NamespacedJob(namespace, body, opts)
...
let apiInstance = new Kubernetes.BatchVolcanoShV1alpha1Api();
let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects
let body = new Kubernetes.ShVolcanoBatchV1alpha1Job(); // ShVolcanoBatchV1alpha1Job | 
let opts = {
...
apiInstance.createBatchVolcanoShV1alpha1NamespacedJob(namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **body** | [**ShVolcanoBatchV1alpha1Job**](ShVolcanoBatchV1alpha1Job.md)|  | 
...
[**ShVolcanoBatchV1alpha1Job**](ShVolcanoBatchV1alpha1Job.md)
...
> IoK8sApimachineryPkgApisMetaV1Status deleteBatchVolcanoShV1alpha1CollectionNamespacedJob(namespace, opts)
...
apiInstance.deleteBatchVolcanoShV1alpha1CollectionNamespacedJob(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteBatchVolcanoShV1alpha1NamespacedJob(name, namespace, opts)
...
apiInstance.deleteBatchVolcanoShV1alpha1NamespacedJob(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## listBatchVolcanoShV1alpha1JobForAllNamespaces

> ShVolcanoBatchV1alpha1JobList listBatchVolcanoShV1alpha1JobForAllNamespaces(opts)



list objects of kind Job
...
apiInstance.listBatchVolcanoShV1alpha1JobForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**ShVolcanoBatchV1alpha1JobList**](ShVolcanoBatchV1alpha1JobList.md)
...
> ShVolcanoBatchV1alpha1JobList listBatchVolcanoShV1alpha1NamespacedJob(namespace, opts)
...
apiInstance.listBatchVolcanoShV1alpha1NamespacedJob(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ShVolcanoBatchV1alpha1Job patchBatchVolcanoShV1alpha1NamespacedJob(name, namespace, body, opts)
...
apiInstance.patchBatchVolcanoShV1alpha1NamespacedJob(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## patchBatchVolcanoShV1alpha1NamespacedJobStatus

> ShVolcanoBatchV1alpha1Job patchBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, body, opts)
...
apiInstance.patchBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ShVolcanoBatchV1alpha1Job readBatchVolcanoShV1alpha1NamespacedJob(name, namespace, opts)
...
apiInstance.readBatchVolcanoShV1alpha1NamespacedJob(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## readBatchVolcanoShV1alpha1NamespacedJobStatus

> ShVolcanoBatchV1alpha1Job readBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, opts)
...
apiInstance.readBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ShVolcanoBatchV1alpha1Job replaceBatchVolcanoShV1alpha1NamespacedJob(name, namespace, body, opts)
...
apiInstance.replaceBatchVolcanoShV1alpha1NamespacedJob(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## replaceBatchVolcanoShV1alpha1NamespacedJobStatus

> ShVolcanoBatchV1alpha1Job replaceBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, body, opts)
...
apiInstance.replaceBatchVolcanoShV1alpha1NamespacedJobStatus(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
