...
> IoK8sApiNodeV1RuntimeClass createNodeV1RuntimeClass(body, opts)
...
let apiInstance = new Kubernetes.NodeV1Api();
let body = new Kubernetes.IoK8sApiNodeV1RuntimeClass(); // IoK8sApiNodeV1RuntimeClass | 
let opts = {
...
apiInstance.createNodeV1RuntimeClass(body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> IoK8sApimachineryPkgApisMetaV1Status deleteNodeV1CollectionRuntimeClass(opts)
...
apiInstance.deleteNodeV1CollectionRuntimeClass(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteNodeV1RuntimeClass(name, opts)
...
apiInstance.deleteNodeV1RuntimeClass(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Kubernetes.NodeV1Api();
apiInstance.getNodeV1APIResources((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiNodeV1RuntimeClassList listNodeV1RuntimeClass(opts)
...
apiInstance.listNodeV1RuntimeClass(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiNodeV1RuntimeClass patchNodeV1RuntimeClass(name, body, opts)
...
apiInstance.patchNodeV1RuntimeClass(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiNodeV1RuntimeClass readNodeV1RuntimeClass(name, opts)
...
apiInstance.readNodeV1RuntimeClass(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiNodeV1RuntimeClass replaceNodeV1RuntimeClass(name, body, opts)
...
apiInstance.replaceNodeV1RuntimeClass(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchNodeV1RuntimeClass(name, opts)
...
apiInstance.watchNodeV1RuntimeClass(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchNodeV1RuntimeClassList(opts)
...
apiInstance.watchNodeV1RuntimeClassList(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
