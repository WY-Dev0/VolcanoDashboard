# Kubernetes.BusVolcanoShV1alpha1Api

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#createBusVolcanoShV1alpha1NamespacedCommand) | **POST** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands | 
[**deleteBusVolcanoShV1alpha1CollectionNamespacedCommand**](BusVolcanoShV1alpha1Api.md#deleteBusVolcanoShV1alpha1CollectionNamespacedCommand) | **DELETE** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands | 
[**deleteBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#deleteBusVolcanoShV1alpha1NamespacedCommand) | **DELETE** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands/{name} | 
[**listBusVolcanoShV1alpha1CommandForAllNamespaces**](BusVolcanoShV1alpha1Api.md#listBusVolcanoShV1alpha1CommandForAllNamespaces) | **GET** /apis/bus.volcano.sh/v1alpha1/commands | 
[**listBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#listBusVolcanoShV1alpha1NamespacedCommand) | **GET** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands | 
[**patchBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#patchBusVolcanoShV1alpha1NamespacedCommand) | **PATCH** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands/{name} | 
[**readBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#readBusVolcanoShV1alpha1NamespacedCommand) | **GET** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands/{name} | 
[**replaceBusVolcanoShV1alpha1NamespacedCommand**](BusVolcanoShV1alpha1Api.md#replaceBusVolcanoShV1alpha1NamespacedCommand) | **PUT** /apis/bus.volcano.sh/v1alpha1/namespaces/{namespace}/commands/{name} | 



## createBusVolcanoShV1alpha1NamespacedCommand

> ShVolcanoBusV1alpha1Command createBusVolcanoShV1alpha1NamespacedCommand(namespace, body, opts)
...
let apiInstance = new Kubernetes.BusVolcanoShV1alpha1Api();
let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects
let body = new Kubernetes.ShVolcanoBusV1alpha1Command(); // ShVolcanoBusV1alpha1Command | 
let opts = {
...
apiInstance.createBusVolcanoShV1alpha1NamespacedCommand(namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
 ...
 **body** | [**ShVolcanoBusV1alpha1Command**](ShVolcanoBusV1alpha1Command.md)|  | 
...
[**ShVolcanoBusV1alpha1Command**](ShVolcanoBusV1alpha1Command.md)
...
## deleteBusVolcanoShV1alpha1CollectionNamespacedCommand

> IoK8sApimachineryPkgApisMetaV1Status deleteBusVolcanoShV1alpha1CollectionNamespacedCommand(namespace, opts)
...
apiInstance.deleteBusVolcanoShV1alpha1CollectionNamespacedCommand(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## deleteBusVolcanoShV1alpha1NamespacedCommand

> IoK8sApimachineryPkgApisMetaV1Status deleteBusVolcanoShV1alpha1NamespacedCommand(name, namespace, opts)
...
let apiInstance = new Kubernetes.BusVolcanoShV1alpha1Api();
let name = "name_example"; // String | name of the Command
let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects
let opts = {
  'pretty': "pretty_example", // String | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
  'dryRun': "dryRun_example", // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
apiInstance.deleteBusVolcanoShV1alpha1NamespacedCommand(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## listBusVolcanoShV1alpha1CommandForAllNamespaces

> ShVolcanoBusV1alpha1CommandList listBusVolcanoShV1alpha1CommandForAllNamespaces(opts)
...
apiInstance.listBusVolcanoShV1alpha1CommandForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**ShVolcanoBusV1alpha1CommandList**](ShVolcanoBusV1alpha1CommandList.md)
...
## listBusVolcanoShV1alpha1NamespacedCommand

> ShVolcanoBusV1alpha1CommandList listBusVolcanoShV1alpha1NamespacedCommand(namespace, opts)
...
apiInstance.listBusVolcanoShV1alpha1NamespacedCommand(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## patchBusVolcanoShV1alpha1NamespacedCommand

> ShVolcanoBusV1alpha1Command patchBusVolcanoShV1alpha1NamespacedCommand(name, namespace, body, opts)
...
apiInstance.patchBusVolcanoShV1alpha1NamespacedCommand(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## readBusVolcanoShV1alpha1NamespacedCommand

> ShVolcanoBusV1alpha1Command readBusVolcanoShV1alpha1NamespacedCommand(name, namespace, opts)
...
apiInstance.readBusVolcanoShV1alpha1NamespacedCommand(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## replaceBusVolcanoShV1alpha1NamespacedCommand

> ShVolcanoBusV1alpha1Command replaceBusVolcanoShV1alpha1NamespacedCommand(name, namespace, body, opts)
...
apiInstance.replaceBusVolcanoShV1alpha1NamespacedCommand(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
