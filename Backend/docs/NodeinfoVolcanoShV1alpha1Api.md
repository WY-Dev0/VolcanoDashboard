# Kubernetes.NodeinfoVolcanoShV1alpha1Api

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#createNodeinfoVolcanoShV1alpha1Numatopology) | **POST** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies | 
[**deleteNodeinfoVolcanoShV1alpha1CollectionNumatopology**](NodeinfoVolcanoShV1alpha1Api.md#deleteNodeinfoVolcanoShV1alpha1CollectionNumatopology) | **DELETE** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies | 
[**deleteNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#deleteNodeinfoVolcanoShV1alpha1Numatopology) | **DELETE** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies/{name} | 
[**listNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#listNodeinfoVolcanoShV1alpha1Numatopology) | **GET** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies | 
[**patchNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#patchNodeinfoVolcanoShV1alpha1Numatopology) | **PATCH** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies/{name} | 
[**readNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#readNodeinfoVolcanoShV1alpha1Numatopology) | **GET** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies/{name} | 
[**replaceNodeinfoVolcanoShV1alpha1Numatopology**](NodeinfoVolcanoShV1alpha1Api.md#replaceNodeinfoVolcanoShV1alpha1Numatopology) | **PUT** /apis/nodeinfo.volcano.sh/v1alpha1/numatopologies/{name} | 



## createNodeinfoVolcanoShV1alpha1Numatopology

> ShVolcanoNodeinfoV1alpha1Numatopology createNodeinfoVolcanoShV1alpha1Numatopology(body, opts)



create a Numatopology
...
let apiInstance = new Kubernetes.NodeinfoVolcanoShV1alpha1Api();
let body = new Kubernetes.ShVolcanoNodeinfoV1alpha1Numatopology(); // ShVolcanoNodeinfoV1alpha1Numatopology | 
let opts = {
...
apiInstance.createNodeinfoVolcanoShV1alpha1Numatopology(body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **body** | [**ShVolcanoNodeinfoV1alpha1Numatopology**](ShVolcanoNodeinfoV1alpha1Numatopology.md)|  | 
...
[**ShVolcanoNodeinfoV1alpha1Numatopology**](ShVolcanoNodeinfoV1alpha1Numatopology.md)
...
## deleteNodeinfoVolcanoShV1alpha1CollectionNumatopology

> IoK8sApimachineryPkgApisMetaV1Status deleteNodeinfoVolcanoShV1alpha1CollectionNumatopology(opts)



delete collection of Numatopology
...
apiInstance.deleteNodeinfoVolcanoShV1alpha1CollectionNumatopology(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## deleteNodeinfoVolcanoShV1alpha1Numatopology

> IoK8sApimachineryPkgApisMetaV1Status deleteNodeinfoVolcanoShV1alpha1Numatopology(name, opts)



delete a Numatopology
...
let apiInstance = new Kubernetes.NodeinfoVolcanoShV1alpha1Api();
let name = "name_example"; // String | name of the Numatopology
let opts = {
  'pretty': "pretty_example", // String | If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
  'dryRun': "dryRun_example", // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
apiInstance.deleteNodeinfoVolcanoShV1alpha1Numatopology(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **String**| name of the Numatopology | 
 **pretty** | **String**| If &#39;true&#39;, then the output is pretty printed. Defaults to &#39;false&#39; unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). | [optional] 
 **dryRun** | **String**| When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed | [optional] 
...
## listNodeinfoVolcanoShV1alpha1Numatopology

> ShVolcanoNodeinfoV1alpha1NumatopologyList listNodeinfoVolcanoShV1alpha1Numatopology(opts)



list objects of kind Numatopology
...
apiInstance.listNodeinfoVolcanoShV1alpha1Numatopology(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
[**ShVolcanoNodeinfoV1alpha1NumatopologyList**](ShVolcanoNodeinfoV1alpha1NumatopologyList.md)
...
## patchNodeinfoVolcanoShV1alpha1Numatopology

> ShVolcanoNodeinfoV1alpha1Numatopology patchNodeinfoVolcanoShV1alpha1Numatopology(name, body, opts)



partially update the specified Numatopology
...
apiInstance.patchNodeinfoVolcanoShV1alpha1Numatopology(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## readNodeinfoVolcanoShV1alpha1Numatopology

> ShVolcanoNodeinfoV1alpha1Numatopology readNodeinfoVolcanoShV1alpha1Numatopology(name, opts)



read the specified Numatopology
...
apiInstance.readNodeinfoVolcanoShV1alpha1Numatopology(name, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
## replaceNodeinfoVolcanoShV1alpha1Numatopology

> ShVolcanoNodeinfoV1alpha1Numatopology replaceNodeinfoVolcanoShV1alpha1Numatopology(name, body, opts)



replace the specified Numatopology
...
apiInstance.replaceNodeinfoVolcanoShV1alpha1Numatopology(name, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
