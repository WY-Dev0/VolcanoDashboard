...
> IoK8sApiEventsV1Event createEventsV1NamespacedEvent(namespace, body, opts)
...
let apiInstance = new Kubernetes.EventsV1Api();
let namespace = "namespace_example"; // String | object name and auth scope, such as for teams and projects
let body = new Kubernetes.IoK8sApiEventsV1Event(); // IoK8sApiEventsV1Event | 
let opts = {
...
apiInstance.createEventsV1NamespacedEvent(namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> IoK8sApimachineryPkgApisMetaV1Status deleteEventsV1CollectionNamespacedEvent(namespace, opts)
...
apiInstance.deleteEventsV1CollectionNamespacedEvent(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1Status deleteEventsV1NamespacedEvent(name, namespace, opts)
...
apiInstance.deleteEventsV1NamespacedEvent(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Kubernetes.EventsV1Api();
apiInstance.getEventsV1APIResources((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiEventsV1EventList listEventsV1EventForAllNamespaces(opts)
...
apiInstance.listEventsV1EventForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiEventsV1EventList listEventsV1NamespacedEvent(namespace, opts)
...
apiInstance.listEventsV1NamespacedEvent(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiEventsV1Event patchEventsV1NamespacedEvent(name, namespace, body, opts)
...
apiInstance.patchEventsV1NamespacedEvent(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiEventsV1Event readEventsV1NamespacedEvent(name, namespace, opts)
...
apiInstance.readEventsV1NamespacedEvent(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApiEventsV1Event replaceEventsV1NamespacedEvent(name, namespace, body, opts)
...
apiInstance.replaceEventsV1NamespacedEvent(name, namespace, body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1EventListForAllNamespaces(opts)
...
apiInstance.watchEventsV1EventListForAllNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1NamespacedEvent(name, namespace, opts)
...
apiInstance.watchEventsV1NamespacedEvent(name, namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1NamespacedEventList(namespace, opts)
...
apiInstance.watchEventsV1NamespacedEventList(namespace, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
