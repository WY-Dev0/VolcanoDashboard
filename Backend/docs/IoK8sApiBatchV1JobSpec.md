...
## Enum: CompletionModeEnum


* `Indexed` (value: `"Indexed"`)

* `NonIndexed` (value: `"NonIndexed"`)





## Enum: PodReplacementPolicyEnum


* `Failed` (value: `"Failed"`)

* `TerminatingOrFailed` (value: `"TerminatingOrFailed"`)
