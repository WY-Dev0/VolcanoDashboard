...
class IoK8sApimachineryPkgApisMetaV1ObjectMeta {
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApimachineryPkgApisMetaV1ObjectMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApimachineryPkgApisMetaV1ObjectMeta</code>.
     */
    static validateJSON(data) {
        ...
        if (data['managedFields']) { // data not null
            ...
            for (const item of data['managedFields']) {
                IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.validateJSON(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['ownerReferences']) { // data not null
            ...
            for (const item of data['ownerReferences']) {
                IoK8sApimachineryPkgApisMetaV1OwnerReference.validateJSON(item);
            };
        }
        // ensure the json data is a string
