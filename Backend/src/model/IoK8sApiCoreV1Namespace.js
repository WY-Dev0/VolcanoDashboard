...
class IoK8sApiCoreV1Namespace {
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1Namespace</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1Namespace</code>.
     */
    static validateJSON(data) {
        ...
        if (data['spec']) { // data not null
          IoK8sApiCoreV1NamespaceSpec.validateJSON(data['spec']);
        }
        // validate the optional field `status`
        if (data['status']) { // data not null
          IoK8sApiCoreV1NamespaceStatus.validateJSON(data['status']);
        }
