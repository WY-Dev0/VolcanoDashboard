...
class IoK8sApiStorageV1CSINode {
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiStorageV1CSINode</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiStorageV1CSINode</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiStorageV1CSINode.RequiredProperties) {
        ...
        if (data['spec']) { // data not null
          IoK8sApiStorageV1CSINodeSpec.validateJSON(data['spec']);
        }
...
IoK8sApiStorageV1CSINode.RequiredProperties = ["spec"];
