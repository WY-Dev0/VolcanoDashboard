...
class IoK8sApiNetworkingV1IngressBackend {
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiNetworkingV1IngressBackend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiNetworkingV1IngressBackend</code>.
     */
    static validateJSON(data) {
        // validate the optional field `resource`
        if (data['resource']) { // data not null
          IoK8sApiCoreV1TypedLocalObjectReference.validateJSON(data['resource']);
        }
        // validate the optional field `service`
        if (data['service']) { // data not null
          IoK8sApiNetworkingV1IngressServiceBackend.validateJSON(data['service']);
        }
