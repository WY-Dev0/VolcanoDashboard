...
/**
 * The IoK8sApiCoreV1EphemeralContainer model module.
 * @module model/IoK8sApiCoreV1EphemeralContainer
 * @version v1.30.0
 */
class IoK8sApiCoreV1EphemeralContainer {
    /**
     * Constructs a new <code>IoK8sApiCoreV1EphemeralContainer</code>.
     * An EphemeralContainer is a temporary container that you may add to an existing Pod for user-initiated activities such as debugging. Ephemeral containers have no resource or scheduling guarantees, and they will not be restarted when they exit or when a Pod is removed or restarted. The kubelet may evict a Pod if an ephemeral container causes the Pod to exceed its resource allocation.  To add an ephemeral container, use the ephemeralcontainers subresource of an existing Pod. Ephemeral containers may not be removed or restarted.
     * @alias module:model/IoK8sApiCoreV1EphemeralContainer
    ...
    constructor(name) { 
        ...
        IoK8sApiCoreV1EphemeralContainer.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>IoK8sApiCoreV1EphemeralContainer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IoK8sApiCoreV1EphemeralContainer} obj Optional instance to populate.
     * @return {module:model/IoK8sApiCoreV1EphemeralContainer} The populated <code>IoK8sApiCoreV1EphemeralContainer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sApiCoreV1EphemeralContainer();
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1EphemeralContainer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1EphemeralContainer</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiCoreV1EphemeralContainer.RequiredProperties) {
...
IoK8sApiCoreV1EphemeralContainer.RequiredProperties = ["name"];
 ...
 */
IoK8sApiCoreV1EphemeralContainer.prototype['args'] = undefined;

/**
 * Entrypoint array. Not executed within a shell. The image's ENTRYPOINT is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. \"$$(VAR_NAME)\" will produce the string literal \"$(VAR_NAME)\". Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell
 * @member {Array.<String>} command
 */
IoK8sApiCoreV1EphemeralContainer.prototype['command'] = undefined;

/**
 * List of environment variables to set in the container. Cannot be updated.
 * @member {Array.<module:model/IoK8sApiCoreV1EnvVar>} env
 */
IoK8sApiCoreV1EphemeralContainer.prototype['env'] = undefined;
 ...
 */
IoK8sApiCoreV1EphemeralContainer.prototype['envFrom'] = undefined;

/**
 * Container image name. More info: https://kubernetes.io/docs/concepts/containers/images
 * @member {String} image
 */
IoK8sApiCoreV1EphemeralContainer.prototype['image'] = undefined;
 ...
 * @member {module:model/IoK8sApiCoreV1EphemeralContainer.ImagePullPolicyEnum} imagePullPolicy
 */
IoK8sApiCoreV1EphemeralContainer.prototype['imagePullPolicy'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1Lifecycle} lifecycle
 */
IoK8sApiCoreV1EphemeralContainer.prototype['lifecycle'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1Probe} livenessProbe
 */
IoK8sApiCoreV1EphemeralContainer.prototype['livenessProbe'] = undefined;

/**
 * Name of the ephemeral container specified as a DNS_LABEL. This name must be unique among all containers, init containers and ephemeral containers.
 * @member {String} name
 */
IoK8sApiCoreV1EphemeralContainer.prototype['name'] = undefined;

/**
 * Ports are not allowed for ephemeral containers.
 * @member {Array.<module:model/IoK8sApiCoreV1ContainerPort>} ports
 */
IoK8sApiCoreV1EphemeralContainer.prototype['ports'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1Probe} readinessProbe
 */
IoK8sApiCoreV1EphemeralContainer.prototype['readinessProbe'] = undefined;

/**
 * Resources resize policy for the container.
 * @member {Array.<module:model/IoK8sApiCoreV1ContainerResizePolicy>} resizePolicy
 */
IoK8sApiCoreV1EphemeralContainer.prototype['resizePolicy'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1ResourceRequirements} resources
 */
IoK8sApiCoreV1EphemeralContainer.prototype['resources'] = undefined;

/**
 * Restart policy for the container to manage the restart behavior of each container within a pod. This may only be set for init containers. You cannot set this field on ephemeral containers.
 * @member {String} restartPolicy
 */
IoK8sApiCoreV1EphemeralContainer.prototype['restartPolicy'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1SecurityContext} securityContext
 */
IoK8sApiCoreV1EphemeralContainer.prototype['securityContext'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1Probe} startupProbe
 */
IoK8sApiCoreV1EphemeralContainer.prototype['startupProbe'] = undefined;

/**
 * Whether this container should allocate a buffer for stdin in the container runtime. If this is not set, reads from stdin in the container will always result in EOF. Default is false.
 * @member {Boolean} stdin
 */
IoK8sApiCoreV1EphemeralContainer.prototype['stdin'] = undefined;
 ...
 */
IoK8sApiCoreV1EphemeralContainer.prototype['stdinOnce'] = undefined;
 ...
 */
IoK8sApiCoreV1EphemeralContainer.prototype['targetContainerName'] = undefined;

/**
 * Optional: Path at which the file to which the container's termination message will be written is mounted into the container's filesystem. Message written is intended to be brief final status, such as an assertion failure message. Will be truncated by the node if greater than 4096 bytes. The total message length across all containers will be limited to 12kb. Defaults to /dev/termination-log. Cannot be updated.
 * @member {String} terminationMessagePath
 */
IoK8sApiCoreV1EphemeralContainer.prototype['terminationMessagePath'] = undefined;
 ...
 * @member {module:model/IoK8sApiCoreV1EphemeralContainer.TerminationMessagePolicyEnum} terminationMessagePolicy
 */
IoK8sApiCoreV1EphemeralContainer.prototype['terminationMessagePolicy'] = undefined;

/**
 * Whether this container should allocate a TTY for itself, also requires 'stdin' to be true. Default is false.
 * @member {Boolean} tty
 */
IoK8sApiCoreV1EphemeralContainer.prototype['tty'] = undefined;

/**
 * volumeDevices is the list of block devices to be used by the container.
 * @member {Array.<module:model/IoK8sApiCoreV1VolumeDevice>} volumeDevices
 */
IoK8sApiCoreV1EphemeralContainer.prototype['volumeDevices'] = undefined;

/**
 * Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated.
 * @member {Array.<module:model/IoK8sApiCoreV1VolumeMount>} volumeMounts
 */
IoK8sApiCoreV1EphemeralContainer.prototype['volumeMounts'] = undefined;

/**
 * Container's working directory. If not specified, the container runtime's default will be used, which might be configured in the container image. Cannot be updated.
 * @member {String} workingDir
 */
IoK8sApiCoreV1EphemeralContainer.prototype['workingDir'] = undefined;
 ...
 * @readonly
 */
IoK8sApiCoreV1EphemeralContainer['ImagePullPolicyEnum'] = {
 ...
 * @readonly
 */
IoK8sApiCoreV1EphemeralContainer['TerminationMessagePolicyEnum'] = {
...
export default IoK8sApiCoreV1EphemeralContainer;
