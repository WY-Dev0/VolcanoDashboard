...
class IoK8sApiCoreV1StorageOSVolumeSource {
    ...
    constructor() { 
        ...
        IoK8sApiCoreV1StorageOSVolumeSource.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1StorageOSVolumeSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1StorageOSVolumeSource</code>.
     */
...
export default IoK8sApiCoreV1StorageOSVolumeSource;
