...
/**
 * The IoK8sApiFlowcontrolV1NonResourcePolicyRule model module.
 * @module model/IoK8sApiFlowcontrolV1NonResourcePolicyRule
 * @version v1.30.0
 */
class IoK8sApiFlowcontrolV1NonResourcePolicyRule {
    /**
     * Constructs a new <code>IoK8sApiFlowcontrolV1NonResourcePolicyRule</code>.
     * NonResourcePolicyRule is a predicate that matches non-resource requests according to their verb and the target non-resource URL. A NonResourcePolicyRule matches a request if and only if both (a) at least one member of verbs matches the request and (b) at least one member of nonResourceURLs matches the request.
     * @alias module:model/IoK8sApiFlowcontrolV1NonResourcePolicyRule
    ...
    constructor(nonResourceURLs, verbs) { 
        ...
        IoK8sApiFlowcontrolV1NonResourcePolicyRule.initialize(this, nonResourceURLs, verbs);
    }
    ...
    /**
     * Constructs a <code>IoK8sApiFlowcontrolV1NonResourcePolicyRule</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IoK8sApiFlowcontrolV1NonResourcePolicyRule} obj Optional instance to populate.
     * @return {module:model/IoK8sApiFlowcontrolV1NonResourcePolicyRule} The populated <code>IoK8sApiFlowcontrolV1NonResourcePolicyRule</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sApiFlowcontrolV1NonResourcePolicyRule();
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiFlowcontrolV1NonResourcePolicyRule</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiFlowcontrolV1NonResourcePolicyRule</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiFlowcontrolV1NonResourcePolicyRule.RequiredProperties) {
...
IoK8sApiFlowcontrolV1NonResourcePolicyRule.RequiredProperties = ["nonResourceURLs", "verbs"];
 ...
 */
IoK8sApiFlowcontrolV1NonResourcePolicyRule.prototype['nonResourceURLs'] = undefined;

/**
 * `verbs` is a list of matching verbs and may not be empty. \"*\" matches all verbs. If it is present, it must be the only entry. Required.
 * @member {Array.<String>} verbs
 */
IoK8sApiFlowcontrolV1NonResourcePolicyRule.prototype['verbs'] = undefined;
...
export default IoK8sApiFlowcontrolV1NonResourcePolicyRule;
