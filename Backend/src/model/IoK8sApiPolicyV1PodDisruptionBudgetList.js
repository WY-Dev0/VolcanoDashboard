...
class IoK8sApiPolicyV1PodDisruptionBudgetList {
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiPolicyV1PodDisruptionBudgetList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiPolicyV1PodDisruptionBudgetList</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiPolicyV1PodDisruptionBudgetList.RequiredProperties) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                IoK8sApiPolicyV1PodDisruptionBudget.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
IoK8sApiPolicyV1PodDisruptionBudgetList.RequiredProperties = ["items"];
