...
/**
 * The IoK8sApiCoreV1ISCSIPersistentVolumeSource model module.
 * @module model/IoK8sApiCoreV1ISCSIPersistentVolumeSource
 * @version v1.30.0
 */
class IoK8sApiCoreV1ISCSIPersistentVolumeSource {
    /**
     * Constructs a new <code>IoK8sApiCoreV1ISCSIPersistentVolumeSource</code>.
     * ISCSIPersistentVolumeSource represents an ISCSI disk. ISCSI volumes can only be mounted as read/write once. ISCSI volumes support ownership management and SELinux relabeling.
     * @alias module:model/IoK8sApiCoreV1ISCSIPersistentVolumeSource
     * @param iqn {String} iqn is Target iSCSI Qualified Name.
     * @param lun {Number} lun is iSCSI Target Lun number.
    ...
    constructor(iqn, lun, targetPortal) { 
        ...
        IoK8sApiCoreV1ISCSIPersistentVolumeSource.initialize(this, iqn, lun, targetPortal);
    }
    ...
    /**
     * Constructs a <code>IoK8sApiCoreV1ISCSIPersistentVolumeSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IoK8sApiCoreV1ISCSIPersistentVolumeSource} obj Optional instance to populate.
     * @return {module:model/IoK8sApiCoreV1ISCSIPersistentVolumeSource} The populated <code>IoK8sApiCoreV1ISCSIPersistentVolumeSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sApiCoreV1ISCSIPersistentVolumeSource();
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1ISCSIPersistentVolumeSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1ISCSIPersistentVolumeSource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiCoreV1ISCSIPersistentVolumeSource.RequiredProperties) {
...
IoK8sApiCoreV1ISCSIPersistentVolumeSource.RequiredProperties = ["iqn", "lun", "targetPortal"];

/**
 * chapAuthDiscovery defines whether support iSCSI Discovery CHAP authentication
 * @member {Boolean} chapAuthDiscovery
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['chapAuthDiscovery'] = undefined;

/**
 * chapAuthSession defines whether support iSCSI Session CHAP authentication
 * @member {Boolean} chapAuthSession
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['chapAuthSession'] = undefined;

/**
 * fsType is the filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \"ext4\", \"xfs\", \"ntfs\". Implicitly inferred to be \"ext4\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#iscsi
 * @member {String} fsType
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['fsType'] = undefined;

/**
 * initiatorName is the custom iSCSI Initiator Name. If initiatorName is specified with iscsiInterface simultaneously, new iSCSI interface <target portal>:<volume name> will be created for the connection.
 * @member {String} initiatorName
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['initiatorName'] = undefined;

/**
 * iqn is Target iSCSI Qualified Name.
 * @member {String} iqn
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['iqn'] = undefined;

/**
 * iscsiInterface is the interface Name that uses an iSCSI transport. Defaults to 'default' (tcp).
 * @member {String} iscsiInterface
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['iscsiInterface'] = undefined;

/**
 * lun is iSCSI Target Lun number.
 * @member {Number} lun
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['lun'] = undefined;

/**
 * portals is the iSCSI Target Portal List. The Portal is either an IP or ip_addr:port if the port is other than default (typically TCP ports 860 and 3260).
 * @member {Array.<String>} portals
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['portals'] = undefined;

/**
 * readOnly here will force the ReadOnly setting in VolumeMounts. Defaults to false.
 * @member {Boolean} readOnly
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['readOnly'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1SecretReference} secretRef
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['secretRef'] = undefined;

/**
 * targetPortal is iSCSI Target Portal. The Portal is either an IP or ip_addr:port if the port is other than default (typically TCP ports 860 and 3260).
 * @member {String} targetPortal
 */
IoK8sApiCoreV1ISCSIPersistentVolumeSource.prototype['targetPortal'] = undefined;
...
export default IoK8sApiCoreV1ISCSIPersistentVolumeSource;
