...
/**
 * The IoK8sApiCoreV1ScaleIOPersistentVolumeSource model module.
 * @module model/IoK8sApiCoreV1ScaleIOPersistentVolumeSource
 * @version v1.30.0
 */
class IoK8sApiCoreV1ScaleIOPersistentVolumeSource {
    /**
     * Constructs a new <code>IoK8sApiCoreV1ScaleIOPersistentVolumeSource</code>.
     * ScaleIOPersistentVolumeSource represents a persistent ScaleIO volume
     * @alias module:model/IoK8sApiCoreV1ScaleIOPersistentVolumeSource
     * @param gateway {String} gateway is the host address of the ScaleIO API Gateway.
     * @param secretRef {module:model/IoK8sApiCoreV1SecretReference} 
    ...
    constructor(gateway, secretRef, system) { 
        ...
        IoK8sApiCoreV1ScaleIOPersistentVolumeSource.initialize(this, gateway, secretRef, system);
    }
    ...
    /**
     * Constructs a <code>IoK8sApiCoreV1ScaleIOPersistentVolumeSource</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/IoK8sApiCoreV1ScaleIOPersistentVolumeSource} obj Optional instance to populate.
     * @return {module:model/IoK8sApiCoreV1ScaleIOPersistentVolumeSource} The populated <code>IoK8sApiCoreV1ScaleIOPersistentVolumeSource</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IoK8sApiCoreV1ScaleIOPersistentVolumeSource();
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1ScaleIOPersistentVolumeSource</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1ScaleIOPersistentVolumeSource</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of IoK8sApiCoreV1ScaleIOPersistentVolumeSource.RequiredProperties) {
...
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.RequiredProperties = ["gateway", "secretRef", "system"];

/**
 * fsType is the filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Default is \"xfs\"
 * @member {String} fsType
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['fsType'] = undefined;

/**
 * gateway is the host address of the ScaleIO API Gateway.
 * @member {String} gateway
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['gateway'] = undefined;

/**
 * protectionDomain is the name of the ScaleIO Protection Domain for the configured storage.
 * @member {String} protectionDomain
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['protectionDomain'] = undefined;

/**
 * readOnly defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
 * @member {Boolean} readOnly
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['readOnly'] = undefined;

/**
 * @member {module:model/IoK8sApiCoreV1SecretReference} secretRef
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['secretRef'] = undefined;

/**
 * sslEnabled is the flag to enable/disable SSL communication with Gateway, default false
 * @member {Boolean} sslEnabled
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['sslEnabled'] = undefined;

/**
 * storageMode indicates whether the storage for a volume should be ThickProvisioned or ThinProvisioned. Default is ThinProvisioned.
 * @member {String} storageMode
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['storageMode'] = undefined;

/**
 * storagePool is the ScaleIO Storage Pool associated with the protection domain.
 * @member {String} storagePool
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['storagePool'] = undefined;

/**
 * system is the name of the storage system as configured in ScaleIO.
 * @member {String} system
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['system'] = undefined;

/**
 * volumeName is the name of a volume already created in the ScaleIO system that is associated with this volume source.
 * @member {String} volumeName
 */
IoK8sApiCoreV1ScaleIOPersistentVolumeSource.prototype['volumeName'] = undefined;
...
export default IoK8sApiCoreV1ScaleIOPersistentVolumeSource;
