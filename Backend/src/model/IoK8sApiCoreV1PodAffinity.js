...
class IoK8sApiCoreV1PodAffinity {
    ...
    constructor() { 
        ...
        IoK8sApiCoreV1PodAffinity.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>IoK8sApiCoreV1PodAffinity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>IoK8sApiCoreV1PodAffinity</code>.
     */
...
export default IoK8sApiCoreV1PodAffinity;
