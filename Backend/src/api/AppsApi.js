...
export default class AppsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAppsAPIGroup operation.
     * @callback module:api/AppsApi~getAppsAPIGroupCallback
     ...
     * @param {module:api/AppsApi~getAppsAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getAppsAPIGroup(callback) {
      let postBody = null;
