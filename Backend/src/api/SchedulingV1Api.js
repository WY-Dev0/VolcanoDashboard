...
/**
* SchedulingV1 service.
* @module api/SchedulingV1Api
* @version v1.30.0
*/
export default class SchedulingV1Api {

    /**
    * Constructs a new SchedulingV1Api. 
    * @alias module:api/SchedulingV1Api
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~createSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiSchedulingV1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a PriorityClass
     * @param {module:model/IoK8sApiSchedulingV1PriorityClass} body 
     ...
     * @param {module:api/SchedulingV1Api~createSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiSchedulingV1PriorityClass}
     */
    createSchedulingV1PriorityClass(body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createSchedulingV1PriorityClass");
      }
      ...
      let returnType = IoK8sApiSchedulingV1PriorityClass;
    ...
    /**
     * Callback function to receive the result of the deleteSchedulingV1CollectionPriorityClass operation.
     * @callback module:api/SchedulingV1Api~deleteSchedulingV1CollectionPriorityClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SchedulingV1Api~deleteSchedulingV1CollectionPriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1Status}
     */
    deleteSchedulingV1CollectionPriorityClass(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the deleteSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~deleteSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [propagationPolicy] Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1DeleteOptions} [body] 
     * @param {module:api/SchedulingV1Api~deleteSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1Status}
     */
    deleteSchedulingV1PriorityClass(name, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling deleteSchedulingV1PriorityClass");
      }
    ...
    /**
     * Callback function to receive the result of the getSchedulingV1APIResources operation.
     * @callback module:api/SchedulingV1Api~getSchedulingV1APIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SchedulingV1Api~getSchedulingV1APIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIResourceList}
     */
    getSchedulingV1APIResources(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the listSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~listSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiSchedulingV1PriorityClassList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SchedulingV1Api~listSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiSchedulingV1PriorityClassList}
     */
    listSchedulingV1PriorityClass(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = IoK8sApiSchedulingV1PriorityClassList;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the patchSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~patchSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiSchedulingV1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SchedulingV1Api~patchSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiSchedulingV1PriorityClass}
     */
    patchSchedulingV1PriorityClass(name, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling patchSchedulingV1PriorityClass");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling patchSchedulingV1PriorityClass");
      }
    ...
    /**
     * Callback function to receive the result of the readSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~readSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiSchedulingV1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [pretty] If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
     * @param {module:api/SchedulingV1Api~readSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiSchedulingV1PriorityClass}
     */
    readSchedulingV1PriorityClass(name, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling readSchedulingV1PriorityClass");
      }
    ...
    /**
     * Callback function to receive the result of the replaceSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~replaceSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiSchedulingV1PriorityClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [fieldManager] fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {String} [fieldValidation] fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
     * @param {module:api/SchedulingV1Api~replaceSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiSchedulingV1PriorityClass}
     */
    replaceSchedulingV1PriorityClass(name, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling replaceSchedulingV1PriorityClass");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling replaceSchedulingV1PriorityClass");
      }
    ...
    /**
     * Callback function to receive the result of the watchSchedulingV1PriorityClass operation.
     * @callback module:api/SchedulingV1Api~watchSchedulingV1PriorityClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} [timeoutSeconds] Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} [watch] Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/SchedulingV1Api~watchSchedulingV1PriorityClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent}
     */
    watchSchedulingV1PriorityClass(name, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling watchSchedulingV1PriorityClass");
      }
    ...
    /**
     * Callback function to receive the result of the watchSchedulingV1PriorityClassList operation.
     * @callback module:api/SchedulingV1Api~watchSchedulingV1PriorityClassListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [timeoutSeconds] Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} [watch] Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/SchedulingV1Api~watchSchedulingV1PriorityClassListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent}
     */
    watchSchedulingV1PriorityClassList(opts, callback) {
      opts = opts || {};
      let postBody = null;
