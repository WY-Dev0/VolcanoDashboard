...
export default class EventsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getEventsAPIGroup operation.
     * @callback module:api/EventsApi~getEventsAPIGroupCallback
     ...
     * @param {module:api/EventsApi~getEventsAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getEventsAPIGroup(callback) {
      let postBody = null;
