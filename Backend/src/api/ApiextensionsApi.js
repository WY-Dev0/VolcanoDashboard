...
export default class ApiextensionsApi {
    ...
    * @alias module:api/ApiextensionsApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getApiextensionsAPIGroup operation.
     * @callback module:api/ApiextensionsApi~getApiextensionsAPIGroupCallback
     ...
     * @param {module:api/ApiextensionsApi~getApiextensionsAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getApiextensionsAPIGroup(callback) {
      let postBody = null;
