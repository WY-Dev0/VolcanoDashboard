...
export default class DiscoveryApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getDiscoveryAPIGroup operation.
     * @callback module:api/DiscoveryApi~getDiscoveryAPIGroupCallback
     ...
     * @param {module:api/DiscoveryApi~getDiscoveryAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getDiscoveryAPIGroup(callback) {
      let postBody = null;
