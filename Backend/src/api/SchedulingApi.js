...
export default class SchedulingApi {
    ...
    * @alias module:api/SchedulingApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getSchedulingAPIGroup operation.
     * @callback module:api/SchedulingApi~getSchedulingAPIGroupCallback
     ...
     * @param {module:api/SchedulingApi~getSchedulingAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getSchedulingAPIGroup(callback) {
      let postBody = null;
