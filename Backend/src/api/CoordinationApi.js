...
export default class CoordinationApi {
    ...
    * @alias module:api/CoordinationApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCoordinationAPIGroup operation.
     * @callback module:api/CoordinationApi~getCoordinationAPIGroupCallback
     ...
     * @param {module:api/CoordinationApi~getCoordinationAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getCoordinationAPIGroup(callback) {
      let postBody = null;
