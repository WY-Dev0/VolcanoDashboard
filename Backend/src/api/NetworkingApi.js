...
export default class NetworkingApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNetworkingAPIGroup operation.
     * @callback module:api/NetworkingApi~getNetworkingAPIGroupCallback
     ...
     * @param {module:api/NetworkingApi~getNetworkingAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getNetworkingAPIGroup(callback) {
      let postBody = null;
