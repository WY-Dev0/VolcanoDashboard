...
export default class CertificatesApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getCertificatesAPIGroup operation.
     * @callback module:api/CertificatesApi~getCertificatesAPIGroupCallback
     ...
     * @param {module:api/CertificatesApi~getCertificatesAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getCertificatesAPIGroup(callback) {
      let postBody = null;
