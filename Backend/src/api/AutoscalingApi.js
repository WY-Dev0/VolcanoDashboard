...
export default class AutoscalingApi {
    ...
    * @alias module:api/AutoscalingApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAutoscalingAPIGroup operation.
     * @callback module:api/AutoscalingApi~getAutoscalingAPIGroupCallback
     ...
     * @param {module:api/AutoscalingApi~getAutoscalingAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getAutoscalingAPIGroup(callback) {
      let postBody = null;
