...
export default class NodeApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getNodeAPIGroup operation.
     * @callback module:api/NodeApi~getNodeAPIGroupCallback
     ...
     * @param {module:api/NodeApi~getNodeAPIGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIGroup}
     */
    getNodeAPIGroup(callback) {
      let postBody = null;
