...
/**
* NodeV1 service.
* @module api/NodeV1Api
* @version v1.30.0
*/
export default class NodeV1Api {

    /**
    * Constructs a new NodeV1Api. 
    * @alias module:api/NodeV1Api
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~createNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiNodeV1RuntimeClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * create a RuntimeClass
     * @param {module:model/IoK8sApiNodeV1RuntimeClass} body 
     ...
     * @param {module:api/NodeV1Api~createNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiNodeV1RuntimeClass}
     */
    createNodeV1RuntimeClass(body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createNodeV1RuntimeClass");
      }
      ...
      let returnType = IoK8sApiNodeV1RuntimeClass;
    ...
    /**
     * Callback function to receive the result of the deleteNodeV1CollectionRuntimeClass operation.
     * @callback module:api/NodeV1Api~deleteNodeV1CollectionRuntimeClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NodeV1Api~deleteNodeV1CollectionRuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1Status}
     */
    deleteNodeV1CollectionRuntimeClass(opts, callback) {
      opts = opts || {};
    ...
    /**
     * Callback function to receive the result of the deleteNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~deleteNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1Status} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [propagationPolicy] Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1DeleteOptions} [body] 
     * @param {module:api/NodeV1Api~deleteNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1Status}
     */
    deleteNodeV1RuntimeClass(name, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling deleteNodeV1RuntimeClass");
      }
    ...
    /**
     * Callback function to receive the result of the getNodeV1APIResources operation.
     * @callback module:api/NodeV1Api~getNodeV1APIResourcesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/NodeV1Api~getNodeV1APIResourcesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1APIResourceList}
     */
    getNodeV1APIResources(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the listNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~listNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiNodeV1RuntimeClassList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NodeV1Api~listNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiNodeV1RuntimeClassList}
     */
    listNodeV1RuntimeClass(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = IoK8sApiNodeV1RuntimeClassList;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the patchNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~patchNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiNodeV1RuntimeClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/NodeV1Api~patchNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiNodeV1RuntimeClass}
     */
    patchNodeV1RuntimeClass(name, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling patchNodeV1RuntimeClass");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling patchNodeV1RuntimeClass");
      }
    ...
    /**
     * Callback function to receive the result of the readNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~readNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiNodeV1RuntimeClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [pretty] If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget).
     * @param {module:api/NodeV1Api~readNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiNodeV1RuntimeClass}
     */
    readNodeV1RuntimeClass(name, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling readNodeV1RuntimeClass");
      }
    ...
    /**
     * Callback function to receive the result of the replaceNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~replaceNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApiNodeV1RuntimeClass} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} [fieldManager] fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     * @param {String} [fieldValidation] fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
     * @param {module:api/NodeV1Api~replaceNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApiNodeV1RuntimeClass}
     */
    replaceNodeV1RuntimeClass(name, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling replaceNodeV1RuntimeClass");
      }
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling replaceNodeV1RuntimeClass");
      }
    ...
    /**
     * Callback function to receive the result of the watchNodeV1RuntimeClass operation.
     * @callback module:api/NodeV1Api~watchNodeV1RuntimeClassCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} [timeoutSeconds] Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} [watch] Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/NodeV1Api~watchNodeV1RuntimeClassCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent}
     */
    watchNodeV1RuntimeClass(name, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'name' is set
      if (name === undefined || name === null) {
        throw new Error("Missing the required parameter 'name' when calling watchNodeV1RuntimeClass");
      }
      ...
      return this.apiClient.callApi(
        '/apis/node.k8s.io/v1/watch/runtimeclasses/{name}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the watchNodeV1RuntimeClassList operation.
     * @callback module:api/NodeV1Api~watchNodeV1RuntimeClassListCallback
     * @param {String} error Error message, if any.
     * @param {module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} [timeoutSeconds] Timeout for the list/watch call. This limits the duration of the call, regardless of any activity or inactivity.
     * @param {Boolean} [watch] Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     * @param {module:api/NodeV1Api~watchNodeV1RuntimeClassListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/IoK8sApimachineryPkgApisMetaV1WatchEvent}
     */
    watchNodeV1RuntimeClassList(opts, callback) {
      opts = opts || {};
      let postBody = null;
