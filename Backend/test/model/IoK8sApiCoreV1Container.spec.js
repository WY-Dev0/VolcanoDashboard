...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1Container();
  });
  ...
  describe('IoK8sApiCoreV1Container', function() {
    it('should create an instance of IoK8sApiCoreV1Container', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1Container
      //var instance = new Kubernetes.IoK8sApiCoreV1Container();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1Container);
    });
