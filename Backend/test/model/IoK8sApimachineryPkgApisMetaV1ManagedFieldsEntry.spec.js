...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry();
  });
  ...
  describe('IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry', function() {
    it('should create an instance of IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry', function() {
      // uncomment below and update the code to test IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry
      //var instance = new Kubernetes.IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry();
      //expect(instance).to.be.a(Kubernetes.IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry);
    });
