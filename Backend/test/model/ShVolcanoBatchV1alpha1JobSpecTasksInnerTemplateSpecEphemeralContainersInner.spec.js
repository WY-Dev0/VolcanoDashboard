...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner();
  });
  ...
  describe('ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner', function() {
    it('should create an instance of ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner', function() {
      // uncomment below and update the code to test ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner
      //var instance = new Kubernetes.ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner();
      //expect(instance).to.be.a(Kubernetes.ShVolcanoBatchV1alpha1JobSpecTasksInnerTemplateSpecEphemeralContainersInner);
    });
