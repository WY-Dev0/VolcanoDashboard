...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1RBDVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1RBDVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1RBDVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1RBDVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1RBDVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1RBDVolumeSource);
    });
