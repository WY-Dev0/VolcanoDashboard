...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1ServiceAccount();
  });
  ...
  describe('IoK8sApiCoreV1ServiceAccount', function() {
    it('should create an instance of IoK8sApiCoreV1ServiceAccount', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1ServiceAccount
      //var instance = new Kubernetes.IoK8sApiCoreV1ServiceAccount();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1ServiceAccount);
    });
