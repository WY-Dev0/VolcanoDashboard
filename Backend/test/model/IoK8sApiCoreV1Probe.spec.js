...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1Probe();
  });
  ...
  describe('IoK8sApiCoreV1Probe', function() {
    it('should create an instance of IoK8sApiCoreV1Probe', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1Probe
      //var instance = new Kubernetes.IoK8sApiCoreV1Probe();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1Probe);
    });
