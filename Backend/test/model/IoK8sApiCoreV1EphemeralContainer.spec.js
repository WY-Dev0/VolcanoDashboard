...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1EphemeralContainer();
  });
  ...
  describe('IoK8sApiCoreV1EphemeralContainer', function() {
    it('should create an instance of IoK8sApiCoreV1EphemeralContainer', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1EphemeralContainer
      //var instance = new Kubernetes.IoK8sApiCoreV1EphemeralContainer();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1EphemeralContainer);
    });
