...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1NodeAffinity();
  });
  ...
  describe('IoK8sApiCoreV1NodeAffinity', function() {
    it('should create an instance of IoK8sApiCoreV1NodeAffinity', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1NodeAffinity
      //var instance = new Kubernetes.IoK8sApiCoreV1NodeAffinity();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1NodeAffinity);
    });
