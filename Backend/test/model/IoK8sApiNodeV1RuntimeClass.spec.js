...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiNodeV1RuntimeClass();
  });
  ...
  describe('IoK8sApiNodeV1RuntimeClass', function() {
    it('should create an instance of IoK8sApiNodeV1RuntimeClass', function() {
      // uncomment below and update the code to test IoK8sApiNodeV1RuntimeClass
      //var instance = new Kubernetes.IoK8sApiNodeV1RuntimeClass();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiNodeV1RuntimeClass);
    });
