...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiStorageV1VolumeAttachmentStatus();
  });
  ...
  describe('IoK8sApiStorageV1VolumeAttachmentStatus', function() {
    it('should create an instance of IoK8sApiStorageV1VolumeAttachmentStatus', function() {
      // uncomment below and update the code to test IoK8sApiStorageV1VolumeAttachmentStatus
      //var instance = new Kubernetes.IoK8sApiStorageV1VolumeAttachmentStatus();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiStorageV1VolumeAttachmentStatus);
    });
