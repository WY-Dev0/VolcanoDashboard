...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1ReplicationControllerStatus();
  });
  ...
  describe('IoK8sApiCoreV1ReplicationControllerStatus', function() {
    it('should create an instance of IoK8sApiCoreV1ReplicationControllerStatus', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1ReplicationControllerStatus
      //var instance = new Kubernetes.IoK8sApiCoreV1ReplicationControllerStatus();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1ReplicationControllerStatus);
    });
