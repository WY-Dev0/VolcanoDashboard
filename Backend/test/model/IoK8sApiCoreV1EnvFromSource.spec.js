...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1EnvFromSource();
  });
  ...
  describe('IoK8sApiCoreV1EnvFromSource', function() {
    it('should create an instance of IoK8sApiCoreV1EnvFromSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1EnvFromSource
      //var instance = new Kubernetes.IoK8sApiCoreV1EnvFromSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1EnvFromSource);
    });
