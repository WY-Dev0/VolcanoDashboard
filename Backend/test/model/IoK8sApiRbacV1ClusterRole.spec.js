...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiRbacV1ClusterRole();
  });
  ...
  describe('IoK8sApiRbacV1ClusterRole', function() {
    it('should create an instance of IoK8sApiRbacV1ClusterRole', function() {
      // uncomment below and update the code to test IoK8sApiRbacV1ClusterRole
      //var instance = new Kubernetes.IoK8sApiRbacV1ClusterRole();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiRbacV1ClusterRole);
    });
