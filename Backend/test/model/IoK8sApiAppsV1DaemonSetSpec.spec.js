...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiAppsV1DaemonSetSpec();
  });
  ...
  describe('IoK8sApiAppsV1DaemonSetSpec', function() {
    it('should create an instance of IoK8sApiAppsV1DaemonSetSpec', function() {
      // uncomment below and update the code to test IoK8sApiAppsV1DaemonSetSpec
      //var instance = new Kubernetes.IoK8sApiAppsV1DaemonSetSpec();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiAppsV1DaemonSetSpec);
    });
