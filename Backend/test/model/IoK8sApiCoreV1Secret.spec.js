...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1Secret();
  });
  ...
  describe('IoK8sApiCoreV1Secret', function() {
    it('should create an instance of IoK8sApiCoreV1Secret', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1Secret
      //var instance = new Kubernetes.IoK8sApiCoreV1Secret();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1Secret);
    });
