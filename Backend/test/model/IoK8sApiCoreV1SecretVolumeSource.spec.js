...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1SecretVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1SecretVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1SecretVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1SecretVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1SecretVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1SecretVolumeSource);
    });
