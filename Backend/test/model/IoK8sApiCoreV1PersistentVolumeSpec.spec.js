...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1PersistentVolumeSpec();
  });
  ...
  describe('IoK8sApiCoreV1PersistentVolumeSpec', function() {
    it('should create an instance of IoK8sApiCoreV1PersistentVolumeSpec', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1PersistentVolumeSpec
      //var instance = new Kubernetes.IoK8sApiCoreV1PersistentVolumeSpec();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1PersistentVolumeSpec);
    });
