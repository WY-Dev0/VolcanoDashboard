...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1PodAffinity();
  });
  ...
  describe('IoK8sApiCoreV1PodAffinity', function() {
    it('should create an instance of IoK8sApiCoreV1PodAffinity', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1PodAffinity
      //var instance = new Kubernetes.IoK8sApiCoreV1PodAffinity();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1PodAffinity);
    });
