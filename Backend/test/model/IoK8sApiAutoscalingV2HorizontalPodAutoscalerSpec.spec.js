...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec();
  });
  ...
  describe('IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec', function() {
    it('should create an instance of IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec', function() {
      // uncomment below and update the code to test IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec
      //var instance = new Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec);
    });
