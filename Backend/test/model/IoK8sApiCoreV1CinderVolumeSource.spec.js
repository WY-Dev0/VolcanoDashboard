...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1CinderVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1CinderVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1CinderVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1CinderVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1CinderVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1CinderVolumeSource);
    });
