...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1StorageOSVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1StorageOSVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1StorageOSVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1StorageOSVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1StorageOSVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1StorageOSVolumeSource);
    });
