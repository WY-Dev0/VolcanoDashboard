...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1PodAntiAffinity();
  });
  ...
  describe('IoK8sApiCoreV1PodAntiAffinity', function() {
    it('should create an instance of IoK8sApiCoreV1PodAntiAffinity', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1PodAntiAffinity
      //var instance = new Kubernetes.IoK8sApiCoreV1PodAntiAffinity();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1PodAntiAffinity);
    });
