...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1ObjectReference();
  });
  ...
  describe('IoK8sApiCoreV1ObjectReference', function() {
    it('should create an instance of IoK8sApiCoreV1ObjectReference', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1ObjectReference
      //var instance = new Kubernetes.IoK8sApiCoreV1ObjectReference();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1ObjectReference);
    });
