...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1CephFSVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1CephFSVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1CephFSVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1CephFSVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1CephFSVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1CephFSVolumeSource);
    });
