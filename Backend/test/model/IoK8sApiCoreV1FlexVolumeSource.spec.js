...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1FlexVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1FlexVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1FlexVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1FlexVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1FlexVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1FlexVolumeSource);
    });
