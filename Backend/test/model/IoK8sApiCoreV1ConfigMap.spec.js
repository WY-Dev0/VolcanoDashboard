...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1ConfigMap();
  });
  ...
  describe('IoK8sApiCoreV1ConfigMap', function() {
    it('should create an instance of IoK8sApiCoreV1ConfigMap', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1ConfigMap
      //var instance = new Kubernetes.IoK8sApiCoreV1ConfigMap();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1ConfigMap);
    });
