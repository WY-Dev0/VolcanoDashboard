...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApimachineryPkgApisMetaV1ObjectMeta();
  });
  ...
  describe('IoK8sApimachineryPkgApisMetaV1ObjectMeta', function() {
    it('should create an instance of IoK8sApimachineryPkgApisMetaV1ObjectMeta', function() {
      // uncomment below and update the code to test IoK8sApimachineryPkgApisMetaV1ObjectMeta
      //var instance = new Kubernetes.IoK8sApimachineryPkgApisMetaV1ObjectMeta();
      //expect(instance).to.be.a(Kubernetes.IoK8sApimachineryPkgApisMetaV1ObjectMeta);
    });
