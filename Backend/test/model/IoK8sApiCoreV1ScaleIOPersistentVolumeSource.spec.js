...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1ScaleIOPersistentVolumeSource();
  });
  ...
  describe('IoK8sApiCoreV1ScaleIOPersistentVolumeSource', function() {
    it('should create an instance of IoK8sApiCoreV1ScaleIOPersistentVolumeSource', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1ScaleIOPersistentVolumeSource
      //var instance = new Kubernetes.IoK8sApiCoreV1ScaleIOPersistentVolumeSource();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1ScaleIOPersistentVolumeSource);
    });
