...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus();
  });
  ...
  describe('IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus', function() {
    it('should create an instance of IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus', function() {
      // uncomment below and update the code to test IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus
      //var instance = new Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus);
    });
