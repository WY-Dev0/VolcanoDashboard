...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kubernetes.IoK8sApiCoreV1Affinity();
  });
  ...
  describe('IoK8sApiCoreV1Affinity', function() {
    it('should create an instance of IoK8sApiCoreV1Affinity', function() {
      // uncomment below and update the code to test IoK8sApiCoreV1Affinity
      //var instance = new Kubernetes.IoK8sApiCoreV1Affinity();
      //expect(instance).to.be.a(Kubernetes.IoK8sApiCoreV1Affinity);
    });
